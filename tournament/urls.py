...
urlpatterns = [
    ...
    path('tournament/<uuid:pk>/', views.TournamentsView.as_view(), name="tornament"),
    ...
    path('tournament/single/<uuid:pk>/', views.TournamentView.as_view(), name="tournament-single"),
]
